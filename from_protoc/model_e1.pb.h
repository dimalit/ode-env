...
// source: model_e1.proto

#ifndef PROTOBUF_model_5fe1_2eproto__INCLUDED
#define PROTOBUF_model_5fe1_2eproto__INCLUDED
...
void  protobuf_AddDesc_model_5fe1_2eproto();
void protobuf_AssignDesc_model_5fe1_2eproto();
void protobuf_ShutdownFile_model_5fe1_2eproto();
...
class Person : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void protobuf_ShutdownFile_model_5fe1_2eproto();
...
inline ::google::protobuf::int32 Person::dummy(int index) const {
  // @@protoc_insertion_point(field_get:Person.dummy)
  return dummy_.Get(index);
}
inline void Person::set_dummy(int index, ::google::protobuf::int32 value) {
  dummy_.Set(index, value);
  // @@protoc_insertion_point(field_set:Person.dummy)
}
inline void Person::add_dummy(::google::protobuf::int32 value) {
  dummy_.Add(value);
  // @@protoc_insertion_point(field_add:Person.dummy)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
Person::dummy() const {
  // @@protoc_insertion_point(field_list:Person.dummy)
  return dummy_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
Person::mutable_dummy() {
  // @@protoc_insertion_point(field_mutable_list:Person.dummy)
  return &dummy_;
}
...
#endif  // PROTOBUF_model_5fe1_2eproto__INCLUDED
